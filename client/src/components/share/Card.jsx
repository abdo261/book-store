...
const Card = ({ book }) => {
 ...
 const{deleteMessage} = useSelector(state=>state.book)
  ...
  return (
    <div className="card-book border rounded-2 my-2 p-1 text-center" onClick={e=>navigateToDetails(e,book._id)}>
      <div className="badge bg-danger">
        {" "}
        {book.price === 0 ? <span className="text-info">FREE</span> : book.price + "$"}{" "}
      </div>
